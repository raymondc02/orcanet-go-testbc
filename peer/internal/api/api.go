...
func InitServer() {
	...
	http.HandleFunc("/getRevenue", getRevenue)
	http.HandleFunc("/getLatestTransaction", getLatestTransaction)
	http.HandleFunc("/getCompleteTransaction", getCompleteTransaction)
	http.HandleFunc("/postTransfer", postTransfer)
	http.HandleFunc("/getSpeed", getSpeed)
	http.HandleFunc("/getFileType", getFileType)
	http.HandleFunc("/getActivity", getActivity)
	http.HandleFunc("/getDeviceList", getDeviceList)
	http.HandleFunc("/putDevice", putDevice)
	http.HandleFunc("/getUnpaidBalance", getUnpaidBalance)
}
